...
export class Xuxemon {
  ...
  // metodos para admin: config y vacunas
  ...
  darXuxemonAleatorio(idJugador: string | number) {
    return this.http.post(`http://127.0.0.1:8000/api/admin/dar-xuxemon-aleatorio`, { user_id: idJugador });
  }
